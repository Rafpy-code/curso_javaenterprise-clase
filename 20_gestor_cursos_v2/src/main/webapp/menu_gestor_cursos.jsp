<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import="model.Curso, model.Usuario, java.util.List"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="ISO-8859-1">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Menu gestor cursos v2</title>
...
<body>
	...
	<main>		
		...
		<table border="1px">
			...
			<tr>
				<%
				List<Curso> cursosEncontrados = (List)request.getSession().getAttribute("listaCursos");
			...
			<article id="cursosPrecioMax.jsp">
				<form action="GestorCursosServlet?opcion=3" method="post">
