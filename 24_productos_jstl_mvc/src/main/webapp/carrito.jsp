...
<%-- 	<%request.getSession();%> --%>
	<div class="inicio">
		...
		<%-- <%<tr>
				...
				<td><a href="EliminarProductoServlet?nombre=<%=p.getNombre()%>">
					<img class="trash" src="images/trash-can.png" /></a></td></tr> 			
		<%}}%>--%>
			...
			<c:if test="${!empty sessionScope.carrito}">
				<c:forEach var="producto" items="${sessionScope.carrito}" varStatus="estado">
					<tr>
						...
						<td>
							<a href="EliminarProductoServlet?nombre=${producto.nombre}">
