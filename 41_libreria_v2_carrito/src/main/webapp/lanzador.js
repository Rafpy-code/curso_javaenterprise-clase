...
function agregarCarrito(isbn) {
	...
	function pintarCarrito(params) {
		...
		$.get(url, params, function(data) {
			var tabla = `<table class="table-fixed rounded-md mx-auto w-full"><thead class="border-2 text-white text-right p-2"><tr><th>ISBN</th><th>TÍTULO</th><th>PÁGINAS</th><th>PRECIO</th><th></th></tr></thead><tbody class="text-right p-2">`;
